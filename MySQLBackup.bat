...
:: From http://www.sherweb.com/blog/how-to-automate-mysql-backups/ - requires the zipping utility included as well.

:: FILE HISTORY ----------------------------------------------
:: UPDATE 4-Mar-2016 JCZ Added Day of week and reordered .zip file name date attributes
...
set backuptime=%year%-%mnt%-%day%-%hr%-%min%-%WD%
echo %backuptime%
...
:: MySQL EXE Path
set mysqldumpexe="C:\Program Files\MariaDB 10.1\bin\mysqldump.exe"

:: Error log path
set backupfldr=c:\MySQLBackups\backupfiles\

:: Path to data folder which may differ from install dir
set datafldr="C:\Program Files\MariaDB 10.1\data"
